...
const BasketData: BasketType[] = [
  { id: 1, code: '11', title: 'پالتو پانچ پشمی سایزبزرگ ', count: 2, image: '../../public/Image/Products/11/11.jpg', price: 985000, size: '50', color: 'قرمز' },
  { id: 2, code: '12', title: 'پالتو شنل ترک یقه انگلیسی', count: 1, image: '../../public/Image/Products/12/12.jpg', price: 864000, off: 6, size: '52', color: 'آبی' },
  { id: 3, code: '21', title: 'مانتو سوییت چهارخونه سایزبزرگ', count: 3, image: '../../public/Image/Products/21/21.jpg', price: 540000, off: 15, size: '56', color: 'بنفش' },
  { id: 4, code: '22', title: 'مانتو سوییت خرجکار چرم', count: 4, image: '../../public/Image/Products/22/22.jpg', price: 660000, size: '58', color: 'بنفش' },
]
