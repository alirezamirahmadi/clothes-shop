...
export default function Counter({ value, minValue = 0, maxValue = 10, className, getValue }: CounterProp) {
  ...
  return (
    <>
      <div dir='rtl' className={'border rounded-md flex justify-center overflow-hidden pt-1 w-24 h-9 ' + className}
        ...
        <Typography variant="button" color={theme.palette.textColor.main}>{countValue}</Typography>
