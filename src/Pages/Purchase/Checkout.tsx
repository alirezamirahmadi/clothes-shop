      ...
      <div dir='rtl' className="lg:flex justify-between mt-4">
        <div className="m-3 lg:w-3/5 rounded-md p-3" style={{ backgroundColor: theme.palette.secondColor.main }}>
          ...
          <div className="flex flex-col px-3">
            ...
            <TextFieldBase value={description} onChange={event => setDescription(event.target.value)} variant="outlined" label={<Typography variant="body1" >توضیحات سفارش</Typography>} multiline rows={4} size="small" color="mainColor" sx={{ marginTop: 2 }} />
          </div>
        </div>
        ...
        <div className="mx-3 my-7 py-4 px-6 border shadow-md rounded-md lg:w-2/5 h-fit" style={{ backgroundColor: theme.palette.secondColor.main }}>
          ...
          <div className="flex justify-between my-3">
            ...
            <Typography variant='body2' >{sumPrice.toLocaleString()}{<Toman color='mainColor' />}</Typography>
          </div>
          <Divider />
          <div className="flex justify-between my-3">
            <Typography variant='body2' >حمل و نقل</Typography>
            <Typography variant='body2' >{carryCost.toLocaleString()}{<Toman color='mainColor' />}</Typography>
          </div>
          <Divider />
          <div className="flex justify-between my-3">
            <Typography variant='body1' >مجموع</Typography>
            <Typography variant='h6' >{total.toLocaleString()}{<Toman color='mainColor' />}</Typography>
          </div>
